...
const STATIC_ASSETS = [
  ...
  'energy-game.js',
  'diagnose-wizard.js',
  'hvac-configurator.js',
  'lifecycle-planner.js',
  'rebate-estimator.js',
  'humidity-planner.js',
  'duct-simulator.js',
  'pool-calculator.js',
  ...
  'storm-prep.html',
  'manifest.json',
  'downloaded_images/mascot-logo.svg',
  'downloaded_images/pwa-icon-512.png',
  'downloaded_images/pwa-icon-512-maskable.png',
  'downloaded_images/pwa-icon-192.png',
  'downloaded_images/pwa-icon-192-maskable.png'
];
