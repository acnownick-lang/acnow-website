function initCalendarWidget(){const i=document.getElementById("dispatch-calendar-container");if(!i)return;function m(){const e=[],t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],s=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];let a=new Date;for(a.setDate(a.getDate()+1);e.length<5;){const l=a.getDay();if(l!==0&&l!==6){const y=`${t[l]}, ${s[a.getMonth()]} ${a.getDate()}`;e.push(y)}a.setDate(a.getDate()+1)}return e}const g=m();let r="";const f=(e,t)=>[["Booked","Available","Booked"],["Available","Booked","Available"],["Booked","Available","Available"],["Available","Available","Booked"],["Booked","Booked","Available"]][e%5][t];let n=`
    ...
    `;g.forEach((e,t)=>{const s=e.split(", ");n+=`
