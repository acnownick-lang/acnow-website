...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 3. Emergency Dispatch Wizard Logic
    ...
    window.submitDispatch = async function() {
        ...
        const city = dispatchCityEl ? dispatchCityEl.value : "Unknown";
        ...
        const issueKeyMap = {
            "AC is completely dead / house is hot": "no-power",
            "AC is blowing warm air": "warm-air",
            "System is leaking water / freezing up": "water-leak",
            "Requesting routine tune-up / maintenance": "maintenance"
        };
        const issueVal = statusEl ? (issueKeyMap[statusEl.value] || "warm-air") : "warm-air";
        ...
        const payload = {
            ...
            "ac-issue": issueVal,
            "city": city,
            "message": `Homepage Wizard Dispatch Booking. City: ${city}. System Status: ${status}.`
        };
