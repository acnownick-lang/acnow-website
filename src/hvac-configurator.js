        ...
        configForm.addEventListener("submit", (e) => {
            ...
            if (typeof window.submitFormWithSync === "function") {
                window.submitFormWithSync(e, configForm, payload, () => {
                    if (typeof window.showToast === "function") { window.showToast("HVAC design secured! Our team will contact you to schedule an on-site installation evaluation.", "success"); } else { alert("HVAC design secured! Our team will contact you to schedule an on-site installation evaluation."); }
                    configForm.reset();
